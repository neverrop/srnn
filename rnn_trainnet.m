...
% datadir = '/Users/never/Downloads/storylines_data/';
% A = load([datadir,'london.mat'])
% A1 = A.fc7;
imgpath = '/Users/never/data/GTEA_snack/en/Yin_Snack/';
path = '/Users/never/data/GTEA_snack/en/';
%A = load('/Users/never/data/GTEA_snack/en/all_features.mat');
A = load('/Users/never/data/GTEA_snack/en/all_cropped_features.mat');
A = A.fe;
...
%save('/Users/never/data/GTEA_snack/en/snack_model.mat','net')
save('/Users/never/data/GTEA_snack/en/cropped_snack_model.mat','net')
